...
const Detection = () => {
  const slides = [
    {
      ...
      description: `<strong class='font-black uppercase text-md text-primary'>Việc làm hấp dẫn - ổn định lâu dài</strong> <br/> Chúng tôi đang tuyển dụng nhiều vị trí làm việc tại môi trường chuyên nghiệp, năng động, phù hợp với lao động phổ thông và người mong muốn có thu nhập ổn định.
  ...
  return (
    <section
      ...
      className="relative w-full overflow-hidden pb-[52px] pt-7 md:pb-28 md:pt-16 bg-[#fff8f6]"
    >
