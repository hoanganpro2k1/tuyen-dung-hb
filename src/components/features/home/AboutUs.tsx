...
const AboutUs = () => {
  return (
    <section id="about-us" className="bg-[#fdf8f8] py-10 md:py-20 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-md self-start border border-gold-primary/20">
              ...
              <span className="text-sm md:text-base font-semibold text-red-primary uppercase tracking-wider">Về chúng tôi</span>
            </div>

            <h2 className="text-3xl md:text-5xl font-bold text-red-dark leading-tight">
              Hệ thống giáo dục <br className="hidden md:block" /> 
              <span className="text-red-primary">Học Bá</span> - Ươm mầm tài năng
            </h2>

            <div className="flex flex-col gap-4 text-base md:text-lg text-gray-700 leading-relaxed">
              <p>
                Hệ thống giáo dục Học Bá là đơn vị tiên phong trong việc áp dụng các phương pháp giảng dạy hiện đại, 
                giúp học sinh không chỉ nắm vững kiến thức mà còn phát triển tư duy sáng tạo và kỹ năng giải quyết vấn đề.
              </p>
              <p>
                Với đội ngũ giáo viên tâm huyết, giàu kinh nghiệm và cơ sở vật chất hiện đại, chúng tôi cam kết mang đến 
                môi trường học tập tốt nhất, khơi dậy niềm đam mê học hỏi trong mỗi học sinh.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8 mt-4">
              <div className="flex flex-col gap-2 p-4 bg-white rounded-xl shadow-sm border-l-4 border-gold-primary">
                <span className="text-2xl md:text-3xl font-bold text-red-primary">10+</span>
                <span className="text-xs md:text-sm font-medium text-gray-500 uppercase">Năm kinh nghiệm</span>
              </div>
              <div className="flex flex-col gap-2 p-4 bg-white rounded-xl shadow-sm border-l-4 border-gold-primary">
                <span className="text-2xl md:text-3xl font-bold text-red-primary">5000+</span>
                <span className="text-xs md:text-sm font-medium text-gray-500 uppercase">Học sinh thành công</span>
              </div>
            </div>
